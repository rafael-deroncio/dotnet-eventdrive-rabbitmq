...
DROP TABLE IF EXISTS CERTIFICATE_DISCIPLINE;
...
CREATE TABLE CERTIFICATE (
  CODE_CERTIFICATE INTEGER PRIMARY KEY DEFAULT nextval('seq_certificate'),
...
CREATE TABLE CERTIFICATE_DISCIPLINE(
  CODE_CERTIFICATE_DISCIPLINE INTEGER PRIMARY KEY DEFAULT nextval('seq_certificate_discipline'),
...
CREATE TABLE PROCCESS_EVENT_STATUS (
  ...
  CREATED_AT TIMESTAMP NOT NULL DEFAULT NOW(),
  UPDATED_AT TIMESTAMP NOT NULL DEFAULT NOW(),
  CONSTRAINT CK_STATUS_DESCRIPTION CHECK (DESCRIPTION IN ('Pending', 'OnProcecess', 'Success', 'Error'))
);
